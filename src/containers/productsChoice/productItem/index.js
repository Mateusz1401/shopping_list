...
class ProductItem extends Component {
  counterPlus = () => {
    const { plusQuantity, unsetNewListLoader, item } = this.props;
  ...
  counterMinus = () => {
    const { minusQuantity, unsetNewListLoader, item } = this.props;
...
ProductItem.propTypes = {
  item: PropTypes.PropTypes.oneOfType([PropTypes.array, PropTypes.object])
    .isRequired,
